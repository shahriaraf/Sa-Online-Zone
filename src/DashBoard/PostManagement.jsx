...
const PostManagement = () => {
  ...
  const Step2Details = () => (
    <div className="space-y-6">
      <div className="text-center mb-6 sm:mb-8">
        <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">Step 2: Post Details</h3>
        <p className="text-sm sm:text-base text-gray-600">Add your post content and specifications</p>
      </div>
